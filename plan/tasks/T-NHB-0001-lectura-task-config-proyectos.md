...
- [x] **CA-M-1:** NereoHub detecta y lee el archivo `task_config.yaml` en la raíz de cada proyecto configurado.
- [x] **CA-M-2:** Si el archivo existe, NereoHub utiliza los prefijos e identificadores definidos en `levels` para clasificar las tareas.
- [x] **CA-M-3:** Si el archivo no existe, NereoHub utiliza la lógica de descubrimiento por defecto (fallback).
- [x] **CA-M-4:** La API expone la información del tipo de tarea (maestra vs componente) basada en esta configuración.
